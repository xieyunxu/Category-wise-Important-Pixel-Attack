...
class MultiPoseDetector(BaseDetector):
    ...
    def debug_noise(self, debugger, images, dets, output, img_name, noise, scale=1):
        ...
        for i in range(1):
            ...
            #noise1 = cv2.cvtColor(noise,cv2.COLOR_BGR2GRAY)
            debugger.add_img(noise, img_id='noise_multi_pose')
            debugger.save_img(imgId='noise_multi_pose', path='D:/python/object_detection/CenterNet/outputs/noise/')
